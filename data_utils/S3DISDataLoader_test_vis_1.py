...
class S3DISDataset(Dataset):
    def __init__(self, split='train', data_root='trainval_fullarea', num_point=4096, test_area=5, block_size=1.0, sample_rate=1.0, transform=None):
        ...
        for room_name in self.rooms_split:
            ...
            tmp, _ = np.histogram(labels, range(1,10))
    ...
    def __getitem__(self, idx):
        ...
        # print("xxxx- get 2 ")
        weights = self.labelweights
        # return current_points, current_labels, labelweights, room_idx
...
if __name__ == '__main__':
    ...
    data_root = '/data/REASEARCH/DEEPCROP/PointCloudData/20201127/PUNKTSKY_621_51_TIF_UTM32-ETRS89_txt_test_clear_1/'
    # num_point, test_area, block_size, sample_rate = 4096, 5, 1.0, 0.01
    num_point, test_area, block_size, sample_rate = 4096, 5, 6.0, 0.01
