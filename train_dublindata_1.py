...
from data_utils.DublinData_1 import DublinData_1
...
def main(args):
    ...
    TRAIN_DATASET = DublinData_1(split='train', data_root=root, num_point=NUM_POINT,  block_size=Block_size, sample_rate=1.0, transform=None)
    print("start loading test data ...")
    TEST_DATASET = DublinData_1(split='test', data_root=test_root, num_point=NUM_POINT,  block_size=Block_size, sample_rate=1.0, transform=None)
