...
def main(args):
    ...
    val_root = '/data/REASEARCH/DEEPCROP/PointCloudData/regression/train_test_split_v2/val_set_txt'
...
#     val_root = '/data/REASEARCH/DEEPCROP/PointCloudData/regression/train_test_split_v2/test_set_txt'
...
#     checkpoint = torch.load('log/reg/rgn_point_old_1/checkpoints/best_model.pth')
...
#     classifier = classifier.apply(weights_init(init_type='kaiming'))
