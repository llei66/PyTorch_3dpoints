...
import argparse
import os
from data_utils.part_dataset import PartDataset
import torch
import datetime
import logging
...
#root = 'data/shapenetcore_partanno_segmentation_benchmark_v0_normal/'
    ...
    TRAIN_DATASET = PartDataset(root = root, npoints=args.npoint, split='trainval', normal_channel=args.normal)
    import pdb
    pdb.set_trace()
    trainDataLoader = torch.utils.data.DataLoader(TRAIN_DATASET, batch_size=args.batch_size,shuffle=True, num_workers=4)
    TEST_DATASET = PartDataset(root = root, npoints=args.npoint, split='test', normal_channel=args.normal)
