...
if __name__ == '__main__':
    ...
    from S3DISDataLoader_test import S3DISDataset

    root = '/data/REASEARCH/DEEPCROP/PointCloudData/20201127/PUNKTSKY_621_51_TIF_UTM32-ETRS89_txt_test_clear_1'

    dataset = S3DISDataset(root = root, npoints=2048, split='test', normal_channel=False)
