...
from geodata_util import 
log = logging.getLogger(__name__)


class DenmarkDatasetBase(BaseDataset):
#class DenmarkDatasetBase(Dataset):
    def __init__(self, dataset_opt, split, data_root, use_rgb: bool, block_size, global_z=None):
        #super().__init__(self.dataset_opt)
...
class DenmarkDatasetTrain(DenmarkDatasetBase):
    def __init__(self, dataset_opt, split, data_root, points_per_sample, use_rgb: bool,
...
class GeodataDataset(BaseDataset):
    ...
    def __init__(self, dataset_opt):
        super().__init__(dataset_opt)
        data_root = '/home/dmn774/Deepcrop/data/geodata/test_whole'
        # save_dir = "./dataset"
        ...
        self.train_dataset = DenmarkDatasetTrain(dataset_opt, split='train', data_root=data_root, points_per_sample=points_per_sample, block_size=block_size, transform=None, use_rgb=False)
